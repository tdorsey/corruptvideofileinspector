...
def handle_credential_error(validation_result: CredentialValidationResult, verbose: bool = False) -> None:
    """
    ...
    if verbose and (validation_result.missing_files or validation_result.empty_files):
        ...
        click.echo("  2. Edit docker/secrets/trakt_client_id.txt with your Trakt client ID", err=True)
        click.echo("  3. Edit docker/secrets/trakt_client_secret.txt with your Trakt client secret", err=True)
