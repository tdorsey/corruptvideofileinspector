...
python3 corruptvideoinspector.py /path/to/your/videos
...
```bash
# Show help
python3 corruptvideoinspector.py --help

# List all video files without scanning
python3 corruptvideoinspector.py --list-videos /path/to/videos

# Start scanning from a specific video index (useful for resuming)
python3 corruptvideoinspector.py --start-index 10 /path/to/videos

# Enable verbose output to see ffmpeg details
python3 corruptvideoinspector.py --verbose /path/to/videos

# Generate JSON output with detailed scan results
python3 corruptvideoinspector.py --json /path/to/videos

# Combine multiple options
python3 corruptvideoinspector.py --json --verbose --start-index 5 /path/to/videos

# Show version
python3 corruptvideoinspector.py --version
```
...
```bash
python3 corruptvideoinspector.py ~/Movies
```
...
for dir in /media/video1 /media/video2 /media/video3; do
    echo "Scanning $dir..."
    python3 corruptvideoinspector.py "$dir"
    echo "Completed $dir"
done
```