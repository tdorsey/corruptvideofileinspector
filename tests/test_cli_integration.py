...
class TestCLIHandlerCoreIntegration(unittest.TestCase):
    ...
    def test_setup_logging_function_exists(self):
        ...
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'cli_handler.py'), 'r') as f:
            content = f.read()
    ...
    def test_validate_directory_function_exists(self):
        ...
        self.assertIn('def validate_directory', content)
        self.assertIn('Path(directory).resolve()', content)
        self.assertIn('FileNotFoundError', content)
        self.assertIn('NotADirectoryError', content)
    ...
    def test_validate_arguments_function_exists(self):
        ...
        self.assertIn('def validate_arguments', content)
        self.assertIn('verbose and quiet', content)
        self.assertIn('max_workers <= 0', content)
    ...
    def test_integration_with_utils_and_video_inspector(self):
        ...
        try:
            ...
            from video_inspector import get_all_video_object_files, ScanMode
