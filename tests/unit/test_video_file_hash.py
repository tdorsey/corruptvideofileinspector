...
class TestVideoFileWithHash(unittest.TestCase):
    ...
    def test_video_file_with_hash(self):
        ...
        self.assertEqual(video_file.path, self.test_file)
        self.assertEqual(video_file.sha256_hash, test_hash)
        self.assertEqual(video_file.short_hash, "abcdef12...7890")
    ...
    def test_video_file_without_hash(self):
        ...
        self.assertEqual(video_file.path, self.test_file)
        self.assertEqual(video_file.sha256_hash, "")
        self.assertEqual(video_file.short_hash, "no-hash")
    ...
    def test_short_hash_property_with_short_input(self):
        ...
        self.assertEqual(video_file.short_hash, short_hash)
    ...
    def test_video_file_backwards_compatibility(self):
        ...
        self.assertEqual(video_file.filename, str(self.test_file))
        self.assertEqual(video_file.name, "test_video.mp4")
        self.assertEqual(video_file.stem, "test_video")
        self.assertEqual(video_file.suffix, ".mp4")
        self.assertTrue(video_file.size > 0)
